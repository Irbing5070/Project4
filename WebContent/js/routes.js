...
function initialize(){
	var directionsRerenderOptions={
			markerOptions:{
				icon:new google.maps.MarkerImage("images/OilWell3.png")
			}
	};
	...
	directionsDisplay.setMap(map);
	    ...
	    var onMarkerMouseOver = function() {
	      ...
	      infoWindow1.setContent('<h3>Mexico City</h3><img src="images/cdmx.jpg" /><br> <p>Tipo de sitio: Gas;leo</p><br />   latitude=' +
	   ...
	   var mkr = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Campeche</h3><img src="images/cam.png" /><br> <p>Tipo de sitio: Petr&oacute;leo</p><br />  latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="http://en.wikipedia.org/wiki/Mexico_city">link to site</a>');
	      infoWindow1.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
	  ...
	  var mkr1 = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Tampico</h3><img src="images/tamaulipas.jpg" /><br> <p>Tipo de sitio: Petr&oacute;leo</p><br />   latitude=' +
	  ...
	  var mkr1 = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>San Luis Potosi</h3><img src="images/slp.jpg" /><br /> <p>Tipo de sitio: Petr&oacute;leo & Gas</p><br />  latitude=' +
	   ...
	   var infoWindow1 = new google.maps.InfoWindow;
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Salamanca</h3><img src="images/salgto.jpg" /><br /> <p>Tipo de sitio: Petr&oacute;leo</p><br />latitude=' +
